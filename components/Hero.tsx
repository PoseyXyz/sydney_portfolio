    ...
    return (
        <section className="flex flex-col justify-center items-center h-[92vh]">
            <div className='flex max-w-6xl container flex-col gap-4'>
                ...
                <h2 className='text-[#111111] text-4xl sm:text-5xl font-bold md:text-6xl lg:text-7xl'>Your next <span className='underline animate-pulse'>pragmatic</span> developer</h2>
